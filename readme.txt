...
Банк Bank
 при инициализации принимает значение количества денег balance
 добавляет выигранную ставку increase_balance
 уменьшает проигранную ставку decrease_balance но не в отрицательную область
